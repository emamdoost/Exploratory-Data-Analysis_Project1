...
hist(GAPower, main="Global Active Power", xlab="Global Active Power (kilowatts)", ylab="Frequency", col="Red")
...
## Process is finished.
message("The process of script is finished and plot1.png is created.")  
